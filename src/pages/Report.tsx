    ...
    <div className="space-y-6 animate-fadeIn">
      {result.isDemoData && (
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl px-5 py-3 flex items-center gap-3">
          ...
          <div>
            <span className="text-sm font-medium text-yellow-400">Demo Data</span>
            <span className="text-xs text-yellow-500/70 ml-2">This report was generated with simulated benchmark data.</span>
          </div>
        </div>
      )}
